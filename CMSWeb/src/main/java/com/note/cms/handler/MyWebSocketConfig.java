...
//        registry.addHandler(myWebSocketHandler(),"/websocket.do").addInterceptors(new HandshakeInterceptor());
        registry.addHandler(myWebSocketHandler(),"/wsPicturePush.do").addInterceptors(new HandshakeInterceptor());
...
//        registry.addHandler(systemWebSocketHandler(), "/webSocketServer.do").addInterceptors(new HandshakeInterceptor());
        registry.addHandler(systemWebSocketHandler(), "/wsVideoPush.do").addInterceptors(new HandshakeInterceptor());
        // 使用Sockjs的注册方法
//        registry.addHandler(systemWebSocketHandler(), "/sockjs/webSocketServer.do").withSockJS();
    ...
    public WebSocketHandler myWebSocketHandler(){
        return new PictureWebSocketHandler();
    }
